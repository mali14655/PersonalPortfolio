    ...
    <>
      <div className="w-[85%]   flex flex-col gap-100 ">
        <div className="w-full flex justify-between">
          ...
          <div className="bg-transparent w-[1200px] pb-10 flex justify-center items-center">
            <img
              src="Profile.png"
              className="bg-transparent object-center object-cover "
              alt=""
            />
          </div>
        </div>
        ...
        <div className="w-full p-5 flex flex-col justify-between gap-10">
          ...
          <div className="flex overflow-x-auto space-x-10 custom-scrollbar px-5 py-5">
            {Projects.map((item) => (
              ...
              >
                <div className="relative h-[200px] rounded-[40px]">
                  <a href={item.link} target="_blank">
                    <div className="absolute rounded-[40px] blur-lg opacity-25 inset-0 bg-black hover:cursor-pointer"></div>
                  ...
                  <img
                    src={item.coverLink}
                    className="object-cover w-full h-full object-center  rounded-[40px] "
                    alt=""
                  />
                </div>
